	...
	render() {
		...
		return <TouchableOpacity
				...
				<View style={styles.item_container}>
			        <Image style={styles.item_image} source={this.props.data.kind===1?subscribe:return_book}/>
 		        	<View style={styles.item_info}>
 		        		<TextPingFang style={styles.item_info_title}>《{this.props.data.title}》</TextPingFang>
 		        		<TextPingFang style={styles.item_info_content}>{this.props.data.kind===1?subscribe_c:return_c}</TextPingFang>
 		        	</View>
 		        	{this.state.read?<View></View>:dot}
 		        </View>
 		    </TouchableOpacity>
	}
} 
